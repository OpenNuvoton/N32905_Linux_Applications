...
#ifndef __ASM_ARM_W55FA93_JPEG_H
#define __ASM_ARM_W55FA93_JPEG_H
...
#define DRVJPEG_DEC_PRIMARY_PACKET_RGB555	0x4021//(PDHTAB | DHEND | ORDER)
#define DRVJPEG_DEC_PRIMARY_PACKET_RGB565	0x06021//(PDHTAB | DHEND | RGB555_565 | ORDER )
...
#endif//__ASM_ARM_N90P930_JPEG_H
