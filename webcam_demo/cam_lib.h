...
extern unsigned int jpeg_buffer_size;
extern unsigned char *pJpegBuffer;
extern int cam_fd;
extern unsigned char *backupVideoBuffer;
...
extern int jpegDec(struct v4l2_buffer *buf);
extern unsigned int user_memorypool_enable;
extern int fb_fd;
extern struct fb_var_screeninfo vinfo;
extern struct fb_fix_screeninfo finfo;

extern unsigned int fb_paddress;
#endif
